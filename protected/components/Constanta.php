...
class Constanta
{
	...
	const ip_db = 'oci:dbname=//192.168.8.4:1521/orcladp';
	const db_user = 'ipnextg';
	const db_pass = '123';
	
	// const ip_db = 'oci:dbname=//192.168.2.94:1521/orclbo';
	// const db_user = 'ipnextg';
	// const db_pass = '123';
	...
	//const for birt url
	const URL = "http://192.168.8.30:8080/birt/frameset?__report=lotsreport/";
	...
	public static $movement_type = array('R'=>'Setoran','W'=>'Tarik','B'=>'Bunga','I'=>'Recv IPO','O'=>'Withdraw IPO');//'M'=>'Masuk ke Nsb umum','K'=>'Keluar dr Nsb umum','I'=>'Adjustment IN','O'=>'Adjustment OUT');
