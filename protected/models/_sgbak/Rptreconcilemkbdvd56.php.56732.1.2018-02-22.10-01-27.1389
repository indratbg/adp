...
class Rptreconcilemkbdvd56 extends ARptForm
{
	...
	public function executeRpt()
	{
		...
		try{
			$query  = "CALL   SPR_RECONCILE_VD56(   TO_DATE(:P_END_DATE,'YYYY-MM-DD'),
												    :P_TYPE,
												    :P_USER_ID,
			...
			$command->bindValue(":P_TYPE",$this->rpt_type,PDO::PARAM_STR);
