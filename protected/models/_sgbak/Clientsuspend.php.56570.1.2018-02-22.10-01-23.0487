 ...
 * @property string $trade_conf_send_to
 * @property string $trade_conf_send_freq
 * @property string $def_city
 * @property double $commission_per_sell
 * @property double $commission_per_buy
 * @property string $recommended_by_cd
 * @property string $recommended_by_other
 * @property double $transaction_limit
 * @property double $init_deposit_amount
 * @property string $init_deposit_efek
 * @property double $init_deposit_efek_price
 * @property string $init_deposit_efek_date
 * @property string $id_copy_flg
 * @property string $npwp_copy_flg
 * @property string $koran_copy_flg
 * @property string $copy_other_flg
 * @property string $copy_other
 * @property string $client_class
 * @property string $closed_date
 * @property string $susp_trx
 */
class Clientsuspend extends AActiveRecordSP
{
	...
	public $init_deposit_efek_date_date;
	public $init_deposit_efek_date_month;
	public $init_deposit_efek_date_year;

	public $closed_date_date;
	public $closed_date_month;
	public $closed_date_year;
	public $save_flg ='N';
	...
	public function rules()
	{
		return array(
			...
			array('client_birth_dt, acct_open_dt, next_rollover_dt, ac_expiry_dt, commit_fee_dt, roll_fee_dt, approved_dt, init_deposit_efek_date, closed_date', 'application.components.validator.ADatePickerSwitcherValidatorSP'),
		
			array('cif_number, cr_lim, int_on_payable, int_on_receivable, int_on_adv_recd, grace_period, int_rec_days, int_pay_days, rebate, commission_per, rebate_tottrade, commission_per_sell, commission_per_buy, transaction_limit, init_deposit_amount, init_deposit_efek_price', 'application.components.validator.ANumberSwitcherValidator'),
			
			//array('acct_open_dt', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'client_type_3' => 'Client Type 3',
			'client_title' => 'Client Title',
			'client_birth_dt' => 'Client Birth Date',
			'religion' => 'Religion',
			'acct_open_dt' => 'Acct Open Date',
			...
			'trade_conf_send_to' => 'Trade Conf Send To',
			'trade_conf_send_freq' => 'Trade Conf Send Freq',
			'def_city' => 'Def City',
			'commission_per_sell' => 'Commission Per Sell',
			'commission_per_buy' => 'Commission Per Buy',
			'recommended_by_cd' => 'Recommended By Code',
			'recommended_by_other' => 'Recommended By Other',
			'transaction_limit' => 'Transaction Limit',
			'init_deposit_amount' => 'Init Deposit Amount',
			'init_deposit_efek' => 'Init Deposit Efek',
			'init_deposit_efek_price' => 'Init Deposit Efek Price',
			'init_deposit_efek_date' => 'Init Deposit Efek Date',
			'id_copy_flg' => 'Id Copy Flg',
			'npwp_copy_flg' => 'Npwp Copy Flg',
			'koran_copy_flg' => 'Koran Copy Flg',
			'copy_other_flg' => 'Copy Other Flg',
...
public function executeSpSuspend($exec_status,$old_client_cd)
	{
		$connection  = Yii::app()->db;
		$transaction = $connection->beginTransaction();	
		
		try{
			$query  = "CALL Sp_Mst_CLIENT_SUSPEND_UPD(
						:P_SEARCH_CLIENT_CD,
						:P_CLIENT_CD,
						:P_CIF_NUMBER,
						:P_CLIENT_NAME,
	...
	public function search()
	{
		...
		$criteria->compare('susp_stat',$this->susp_stat,true);
		...
		$criteria->compare('trade_conf_send_to',$this->trade_conf_send_to,true);
		$criteria->compare('trade_conf_send_freq',$this->trade_conf_send_freq,true);
		$criteria->compare('def_city',$this->def_city,true);
		$criteria->compare('commission_per_sell',$this->commission_per_sell);
		$criteria->compare('commission_per_buy',$this->commission_per_buy);
		$criteria->compare('recommended_by_cd',$this->recommended_by_cd,true);
		$criteria->compare('recommended_by_other',$this->recommended_by_other,true);
		$criteria->compare('transaction_limit',$this->transaction_limit);
		$criteria->compare('init_deposit_amount',$this->init_deposit_amount);
		$criteria->compare('init_deposit_efek',$this->init_deposit_efek,true);
		$criteria->compare('init_deposit_efek_price',$this->init_deposit_efek_price);

		if(!empty($this->init_deposit_efek_date_date))
			$criteria->addCondition("TO_CHAR(t.init_deposit_efek_date,'DD') LIKE '%".$this->init_deposit_efek_date_date."%'");
		if(!empty($this->init_deposit_efek_date_month))
			$criteria->addCondition("TO_CHAR(t.init_deposit_efek_date,'MM') LIKE '%".$this->init_deposit_efek_date_month."%'");
		if(!empty($this->init_deposit_efek_date_year))
			$criteria->addCondition("TO_CHAR(t.init_deposit_efek_date,'YYYY') LIKE '%".$this->init_deposit_efek_date_year."%'");		$criteria->compare('id_copy_flg',$this->id_copy_flg,true);
		$criteria->compare('npwp_copy_flg',$this->npwp_copy_flg,true);
		$criteria->compare('koran_copy_flg',$this->koran_copy_flg,true);
		$criteria->compare('copy_other_flg',$this->copy_other_flg,true);
		$criteria->compare('copy_other',$this->copy_other,true);
		$criteria->compare('client_class',$this->client_class,true);

		if(!empty($this->closed_date_date))
			$criteria->addCondition("TO_CHAR(t.closed_date,'DD') LIKE '%".$this->closed_date_date."%'");
		if(!empty($this->closed_date_month))
			$criteria->addCondition("TO_CHAR(t.closed_date,'MM') LIKE '%".$this->closed_date_month."%'");
		if(!empty($this->closed_date_year))
			$criteria->addCondition("TO_CHAR(t.closed_date,'YYYY') LIKE '%".$this->closed_date_year."%'");		$criteria->compare('susp_trx',$this->susp_trx,true);
	$criteria->compare('approved_stat',$this->approved_stat,true);
	$criteria->compare('susp_trx',$this->susp_trx,true);
			$sort = new CSort();
			$sort->defaultOrder = 'cifs,client_cd';
