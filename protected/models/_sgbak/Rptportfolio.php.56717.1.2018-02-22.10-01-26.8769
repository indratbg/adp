...
class Rptportfolio extends ARptForm
{
    ...
    public function rules()
    {
        return array(
            ...
            array(
                'report_type,stk_cd_option, stk_cd,client_cd,branch_cd,rem_cd,acct_type,client_option,branch_option,rem_option',
                'safe'
            )
        );
    }
    ...
    public function executeRpt($bgn_margin, $end_margin, $bgn_client, $end_client, $bgn_branch, $end_branch, $bgn_rem, $end_rem, $bgn_stock, $end_stock,$report_type)
    {
        ...
        try
        {
            $query = "CALL  SPR_RISK_MGMT_PORTO(TO_DATE(:P_TRX_DATE,'YYYY-MM-DD'),
            ...
            $command->bindValue(":P_REPORT_TYPE", $report_type, PDO::PARAM_STR);
