...
class Rptcashdividenhistory extends ARptForm
{
	public $bgn_date;
	public $end_date;
	public $dummy_date;
	...
	public function rules()
	{
		return array(
			...
			array('branch_cd,stk_option,stk_cd,client_option,client_cd','safe')
		);
	}
	...
	public function executeRpt($stk_cd, $client_cd, $branch_cd)
	{
		...
		try{
			$query  = "CALL  SPR_CASH_DIVIDEN_HISTORY(   TO_DATE(:P_BGN_DATE,'YYYY-MM-DD'),
