...
class Tinterestrate extends AActiveRecordSP
{
	...
	public function rules()
	{
		return array(
			...
			array('eff_dt,old_eff_dt', 'application.components.validator.ADatePickerSwitcherValidatorSP'),
			...
			array('cre_dt, upd_dt,cancel_flg,save_flg,old_client_cd,client_cd', 'safe'),
