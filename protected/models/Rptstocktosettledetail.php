...
class Rptstocktosettledetail extends ARptForm
{
	...
	public function rules()
	{
		return array(
			...
			array('client_option,bgn_client, end_client,market_type,stk_type,stk_option,stk_cd_from, stk_cd_to','safe')
		);
	}
	...
	public function executeRpt($bgn_stk, $end_stk, $bgn_client, $end_client, $market_type, $stk_type)
	{
		...
		try{
			$query  = "CALL  SPR_STOCK_TO_SETTLE_DETAIL(TO_DATE(:P_CONTR_DT_FROM,'YYYY-MM-DD'),
			...
			$command->bindValue(":P_MARKET_TYPE",$market_type,PDO::PARAM_STR);
			$command->bindValue(":P_STOCK_TYPE",$stk_type,PDO::PARAM_STR);
