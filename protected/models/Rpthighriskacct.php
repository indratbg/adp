...
class Rpthighriskacct extends ARptForm
{
    ...
    public function rules()
    {
        return array(
            ...
            array('port_ori,port_disc,buy_back', 'application.components.validator.ANumberSwitcherValidator'),
            array('high_risk_type,client_cd,branch_cd,rem_cd,acct_type,client_option,branch_option,rem_option','safe')
        );
    }
    ...
    public function executeRpt($price_date,$bgn_margin, $end_margin, $bgn_client, $end_client, $bgn_branch, $end_branch, $bgn_rem, $end_rem)
    {
        ...
        try{
            $query  = "CALL  SPR_HIGH_RISK_ACCT(TO_DATE(:P_TRX_DATE,'YYYY-MM-DD'),
            ...
            $command->bindValue(":P_LIMIT",$this->port_ori,PDO::PARAM_STR);
            $command->bindValue(":P_LIMIT_disct",$this->port_disc,PDO::PARAM_STR);
            $command->bindValue(":P_HRA_TYPE",$this->high_risk_type,PDO::PARAM_STR);
         ...
         //  $command->bindValue(":P_BUY_BACK",$this->buy_back,PDO::PARAM_STR);
