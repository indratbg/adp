...
class Rptbranchperformance extends ARptForm
{
	public $month;
	public $year;	
	public $bgn_date;	
	...
	public function rules()
	{
		return array(
			...
			array('year,month,contract_option,contract_type,branch_option,branch_cd,rpt_type,rem_option,rem_cd','safe')
		);
	}
	...
	public function executeRpt($bgn_branch,$end_branch , $bgn_rem_cd,$end_rem_cd, $contr_type, $rpt_mode)
	{
		...
		try{
			$query  = "CALL  SPR_PERFORMANCE_BRANCH(TO_DATE(:P_BGN_DATE,'YYYY-MM-DD'),
			...
			$command->bindValue(":P_CONTRACT_TYPE",$contr_type,PDO::PARAM_STR);
