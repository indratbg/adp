...
class Tbondtrx extends AActiveRecordSP
{
	...
	public function rules()
	{
		return array(
			...
			array('lawan_name,nomor_surat,seller,buyer,old_ctp_num,old_trx_id_yymm, seqno, save_flg, report_type, ctp_trx_type, trx_id_yymm, sisa_temp, seller_buy_dt, last_coupon, next_coupon, cre_dt, upd_dt, approved_dt, maturity_date, purchased_bond, calc_accrued_int, calc_interest,isksei', 'safe'),

			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
	
			array('multi_buy_price,old_ctp_num,old_trx_id_yymm,, seqno, save_flg,calc_accrued_int, calc_interest, trx_date, trx_seq_no, trx_type, trx_ref, ctp_num, trx_id, lawan, lawan_type, bond_cd, buy_dt, 
	...
	public function executeSpUpdTicket($exec_status,$record_seq,&$transaction)
	{
		$connection  = Yii::app()->db;			
		try{
			$query  = "CALL SP_BOND_TICKET_UPD(
						TO_DATE(:P_TRX_DATE,'YYYY-MM-DD'),
						:P_TRX_SEQ_NO,
						:P_TRX_ID_YYMM,
						:P_USER_ID,
