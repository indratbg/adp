...
class Rptsecutrialbalancedetail extends ARptForm
{
	public $end_date;
	public $month;
	public $year;
	...
	public function rules()
	{
		return array(
			...
			array('sort_by,stk_option,stk_cd,client_cd,client_option,gl_option,gl_acct,year,month','safe')
		);
	}
	...
	public function executeRpt($bgn_acct,$end_acct,$bgn_client,$end_client,$bgn_stk,$end_stk,$sort_by)
	{
		...
		try{
			$query  = "CALL SPR_SECU_TRIAL_BALANCE_DETAIL(TO_DATE( :P_END_DATE,'YYYY-MM-DD'),
														    :P_BGN_ACCT,
														    :P_END_ACCT,
														    :P_BGN_CLIENT,
														    :P_END_CLIENT,
