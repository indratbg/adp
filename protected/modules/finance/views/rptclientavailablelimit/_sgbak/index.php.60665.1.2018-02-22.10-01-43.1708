...
$this->breadcrumbs = array(
	'Client Available Limit' => array('index'),
	'List',
);

$this->menu = array(
	array(
		'label' => 'Client Available Limit',
...
<div class="row-fluid">
	...
	<div class="span6">
		...
		<div class="control-group">
			...
			<div class="span3">
				<input type="radio" name="Rptclientavailablelimit[available]" value="<>0" <?php echo $model->available=='<>0'?'checked':'';?> /> &nbsp; ALL
			</div>
			<div class="span3">
				<input type="radio" name="Rptclientavailablelimit[available]" value="<0" <?php echo $model->available=='<0'?'checked':'';?> /> &nbsp; Minus
			</div>
			<div class="span3">
				<input type="radio" name="Rptclientavailablelimit[available]" value=">0" <?php echo $model->available=='>0'?'checked':'';?> /> &nbsp; Positive
			</div>
		</div>
		<div class="control-group">
			<div class="span3">
			...
			<div class="span3">
				<input type="radio" name="Rptclientavailablelimit[haircut]" value="0" <?php echo $model->haircut=='0'?'checked':'';?> /> &nbsp; Without Haircut
			</div>
			<div class="span3">
				<input type="radio" name="Rptclientavailablelimit[haircut]" value="1" <?php echo $model->haircut=='1'?'checked':'';?> /> &nbsp; With Haircut
			</div>
...
<script>
	...
	{
	var result = [];
	$('#Rptclientavailablelimit_client_cd').autocomplete(
	{
