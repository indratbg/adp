...
$this->breadcrumbs = array(
	'List of Pay/ Recv Schedule' => array('index'),
	'List',
);

$this->menu = array(
	array(
		'label' => 'List of Pay/ Recv Schedule',
...
<div class="row-fluid">
	...
	<div class="control-group">
		...
		<div class="span3">
			<input type="radio" name="Rptlistofpayrecvsched[type]" id="type_0" value="0" <?php echo $model->type=='0'?'checked':'' ?> />&nbsp; Transaction Date
		</div>
		<div class="span3">
			<input type="radio" name="Rptlistofpayrecvsched[type]" id="type_1" value="1" <?php echo $model->type=='1'?'checked':'' ?> />&nbsp; Settle Date
		</div>
	</div>
...
<script>
	...
	{
		var result = [];
		$('#Rptlistofpayrecvsched_client_cd').autocomplete(
		{
	...
	$('#Rptlistofpayrecvsched_bgn_date').change(function(){
		$('#Rptlistofpayrecvsched_end_date').val($('#Rptlistofpayrecvsched_bgn_date').val());
	});
	
	$('#Rptlistofpayrecvsched_bgn_date').prop('readonly',true);
	//$('#type_0').prop('disabled',true);
</script>
