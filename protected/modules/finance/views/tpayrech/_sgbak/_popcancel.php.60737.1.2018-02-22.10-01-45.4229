...
if($is_successsave): ?>
<script>
    window.parent.closePopupModalAndRedirect('<?php echo $this->createUrl('index') /*Yii::app()->createUrl('/finance/tpayrech/index');*/ ?>')
</script>
<?php endif; ?>
...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array( 
    ...
    <?php 
       ...
       if(isset($modelFolder))echo $form->errorSummary($modelFolder); 
