...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php
		$tabs = array(
			array(
	                'label'   => 'Journal',
	                'content' =>  $this->renderPartial('/tpayrech/_update_remark_detail',array('model'=>$model,'modelDetail'=>$modelDetail,'form'=>$form),true,false),
	                'active'  => true
	            ),
             array(
	                'label'   => 'Cheque',
	                'content' =>  $this->renderPartial('/tpayrech/_update_remark_cheq',array('model'=>$model,'modelCheq'=>$modelCheq,'form'=>$form),true,false),
	                'active'  => false
	            ),
	    );
