...
<script>
	window.parent.closePopupModalAndRedirect('<?php echo Yii::app()->createUrl('/finance/Tdncnh/Index'); ?>')
</script>
<?php endif; ?>
...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array( 
	...
	<?php echo $form->errorSummary(array($model,$model1,$model2,$modelfolder)); ?>
