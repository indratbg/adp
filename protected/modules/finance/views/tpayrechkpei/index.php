...
$this->menu=array(
	array('label'=>'List of KPEI / NEGO Vouchers', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px')),
...
<?php if($controllerId == 'tpayrechkpeialt'): ?>
...
<?php $this->renderPartial('/tpayrechkpei/_search',array(
	'model'=>$model,
)); ?>
</div><!-- search-form -->
