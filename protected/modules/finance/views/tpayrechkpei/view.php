...
$this->menu=array(
	array('label'=>'View '.$model->type.' Voucher '.$model->payrec_num, 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px')),
...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php
		$tabs = array(
			array(
	                'label'   => 'Journal',
	                'content' =>  $this->renderPartial('/tpayrechkpei/_view_detail',array('model'=>$model,'modelDetail'=>$modelDetail,'form'=>$form),true,false),
	                'active'  => true
	            ),
             array(
	                'label'   => 'Cheque',
	                'content' =>  $this->renderPartial('/tpayrechkpei/_view_cheq',array('model'=>$model,'modelCheq'=>$modelCheq,'form'=>$form),true,false),
	                'active'  => false
	            ),
	    );
