...
<?php 
	...
	'Report Reconcile Balance Sheet and Trial Balance'=>array('index'),
	'List',
);

$this->menu=array(
	array('label'=>'Report Reconcile Balance Sheet and Trial Balance', 'itemOptions'=>array('style'=>'font-size:28px;font-weight:bold;color:black;margin-left:-17px;margin-top:8px;')),
