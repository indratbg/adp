...
$this->menu=array(
	array('label'=>'Generate Bond Transaction Journal', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px')),
	array('label'=>'Cancel','url'=>array('cancel'),'icon'=>'list','itemOptions'=>array('style'=>'float:right')),
...
<table id='tableBond' class='table-bordered table-condensed'>
	...
	?>
		<tr id="row<?php echo $x ?>">
			...
			<td width="4%">
				<?php echo $form->textField($row,'trx_type',array('class'=>'span','style'=>'display:none;','name'=>'Tbondtrx['.$x.'][trx_type]','readonly'=>'readonly','value'=>$row->trx_type == 'B' || $row->trx_type == 'Buy'?'Buy':'Sell')); ?>
