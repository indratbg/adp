...
<?php 
	...
	'Report Reconcile General Ledger and Fund Ledger'=>array('index'),
	'List',
);

$this->menu=array(
	array('label'=>'Report Reconcile General Ledger and Fund Ledger', 'itemOptions'=>array('style'=>'font-size:28px;font-weight:bold;color:black;margin-left:-17px;margin-top:8px;')),
