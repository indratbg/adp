...
<?php 
	...
	'Ratio Margin to MKBD'=>array('index'),
	'List',
);

$this->menu=array(
	array('label'=>'Ratio Margin to MKBD', 'itemOptions'=>array('style'=>'font-size:28px;font-weight:bold;color:black;margin-left:-17px;margin-top:8px;')),
...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<pre>Average MKBD setelah tanggal 6 feb 2012 memakai MKBD baru</pre>
	<div class="row-fluid">
		<div class="control-group">
		<?php echo $form->label($model,'Ending Date',array('class'=>'control-label')) ?>
