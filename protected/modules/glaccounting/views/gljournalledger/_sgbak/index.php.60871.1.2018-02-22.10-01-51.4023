...
$this->menu=array(
	array('label'=>'List of GL Journal Entry', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px;margin-top:8px;')),
...
<br/>
<pre><strong>Note : Cancel / Update jurnal menghasilkan tanggal reversal sama dengan tanggal hari ini atau lebih besar dari hari ini(Untuk jurnal non AR/AP)</strong></pre>
	...
	'remarks',
		...
		array(
			...
			'template'=>'{view}{update}{delete}{update remarks}',
			 	'buttons'=>array(
		        'view'=>array(
		        	'url' => 'Yii::app()->createUrl("glaccounting/Gljournalledger/view",array("id"=>$data->jvch_num))',			// AH : change
		        	
		            'icon'=>'eye-open'
		         ),
	
		        'update'=>array(
		        	'url' => 'Yii::app()->createUrl("glaccounting/Gljournalledger/update",array("id"=>$data->jvch_num))',			// AH : change
		            'icon'=>'pencil'),
	         ...
	         'update remarks'=>array(
	        	'url' => 'Yii::app()->createUrl("glaccounting/Gljournalledger/updateremarks",array("id"=>$data->jvch_num))',			// AH : change
