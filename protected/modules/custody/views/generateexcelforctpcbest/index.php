...
$this->breadcrumbs=array(
	'Generate Excel for CTP for CBEST'=>array('index'),
	'List',
);

$this->menu=array(
	array('label'=>'Generate Excel for CTP for CBEST', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px;margin-top:8px;')),
...
<table id='tableGenerateexcelforctp'  class='table-bordered table-condensed' >
	...
	?>
		...
		<tr>
			...
			<td >
				<label style="text-align: right">Custody Cd</label>
			</td>
			<td colspan="2">
				<?php echo $form->dropdownList($row,'lawan_custody_cd',CHtml::listData($custody_cd, 'param_cd3','param_cd3'),array('name'=>'Generateexcelforctp['.$x.'][lawan_custody_cd]','class'=>'span'));?>
			</td>
			<td>
