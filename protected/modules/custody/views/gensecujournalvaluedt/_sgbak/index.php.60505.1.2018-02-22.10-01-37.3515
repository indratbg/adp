...
<style>
	...
	#tableBond tr, #tableBondSource tr
	{
		vertical-align: top;
		border-bottom: 1px;
	}
...
$this->breadcrumbs=array(
	'Gensecujournalvaluedt'=>array('index'),
	'Generate',
);

$this->menu=array(
	array('label'=>'Generate Securities Journal at Value Date', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px')),
...
<table id='tableDummy' class='table-bordered table-condensed'>
	<tbody>
		<tr>
			...
			<td width="4%">
				<?php echo $form->checkBox($modeldummy,'isksei',array('value' => 'Y','name'=>'dummy')); ?>
			</td>
			<td width="7%">
...
<table id='tableBond' class='table-bordered table-condensed'>
	<thead>
		<tr>
			...
			<th id="header8">KSEI</th>
			<th id="header9">Price(%)</th>
			<th id="header10">Net Amount</th>
		</tr>
	</thead>
	<tbody>
	<?php
	...
	?>
		<tr id="row<?php echo $x ?>">
			...
			<td width="4%">
				...
				<?php echo $row->trx_type == 'B'?'Buy':'Sell';?>
			</td>
			<td width="14%">
			...
			<td width="28%">
				...
				<p style="word-break: normal"><?php echo LawanBondTrx::model()->find(array('select'=>'lawan_name','condition'=>"trim(lawan) = '$row->lawan'"))->lawan_name.' ('.$row->lawan.')';?></p>
			</td>
			<td width="4%">
				<?php echo $form->checkBox($row,'isksei',array('value' => 'Y','name'=>'Tbondtrx['.$x.'][isksei]')); ?>
			</td>
			<td width="7%">
