...
$this->breadcrumbs=array(
	'Ctpnumentry'=>array('index'),
	'List',
);

$this->menu=array(
	array('label'=>'CTP Number Entry', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px')),
	array('label'=>'Approval','url'=>Yii::app()->request->baseUrl.'?r=inbox/ctpnumentry/index','icon'=>'list','itemOptions'=>array('style'=>'float:right')),
...
<table id='tableDummy' class='table-bordered table-condensed'>
	<tbody>
		<tr id="row1">
			...
			<td width="13%">
				<?php echo $form->textField($modeldummy,'ctp_num',array('class'=>'span','name'=>'dummy')); ?>
			</td>
		</tr>
	</tbody>	
</table>
	...
	?>
		<tr id="row<?php echo $x ?>">
			<td width="2%">
				...
				<input type="hidden" name="Tbondtrx[<?php echo $x;?>][old_ctp_num]" id="oldctpnum" value="<?php echo $row->old_ctp_num;?>" />
			</td>
			<td width="10%">
			...
			<td width="13%">
				<?php echo $form->textField($row,'ctp_num',array('class'=>'span','name'=>'Tbondtrx['.$x.'][ctp_num]','readonly'=>$row->save_flg!='Y'?'readonly':'')); ?>
			</td>
		</tr>
	<?php $x++;}} ?>
	</tbody>	
</table>
<h4>Input CTP Numbers</h4>
		...
		$("#tableBond").find('tbody')
			...
			.append($('<td>')
				.append($('<input>')
           		...
           		.append($('<input>')
           		 	.attr('class','span')
           		 	.attr('name','Tbondtrx[1][bond_rate]')
					.attr('type','text')
           		)
           	).append($('<td>')
           		 .append($('<a>')
			...
			.append($('<td>')
				.append($('<input>')
           		 ...
           		 .append($('<select>')
           		 	...
           		 	.attr('name','Tbondtrx[1][bond_cd]')
					.attr('type','text')
					.val($("#Tbondtrx_"+num+"_bond_cd").val())
           		)
           	).append($('<td>')
           		 .append($('<input>')
           		 	.attr('class','span')
           		...
           		.append($('<input>')
           		 	...
           		 	.attr('name','Tbondtrx[1][bond_rate]')
					.attr('type','text')
					.val($("#Tbondtrx_"+num+"_bond_rate").val())
           		)
           	).append($('<td>')
           		 .append($('<a>')
       		 		.attr('onClick','deleteRow(this)')
