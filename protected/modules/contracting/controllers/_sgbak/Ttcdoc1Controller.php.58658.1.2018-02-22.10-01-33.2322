...
class Ttcdoc1Controller extends AAdminController
{
	public function genTCeng($client_cd, $tc_date, $rem_cd, $branch_code, $user_id){
		...
		$model = Rtradeconf::model()->findAll(array('condition'=>"to_char(contr_dt,'YYYY-MM-DD HH24:MI:SS') = '$tc_date' and client_cd like '$client_cd' 
			...
			*/	
		$model = Rtradeconf::model()->findAll(array('condition'=>"to_char(contr_dt,'YYYY-MM-DD HH24:MI:SS') = '$tc_date' and client_cd like '$client_cd' 
		and  userid = '$user_id'",'order'=>'beli_jual, stk_cd'));		
		...
		if($model){
			...
			if ($model[0]->sum_b_amt > $model[0]->sum_j_amt){
				...
				$tc = $tc."
							<tr style=\"border-bottom: 1.5px solid;\">
								<td colspan=\"5\"><strong>Credit</strong></td>
								<td style=\"text-align: right;\"></td>
								<td style=\"text-align: right;\"></td>
								<td style=\"text-align: right;\"><strong>Rp</strong></td>
								<td style=\"text-align: right;\"><strong>".number_format($model[0]->sum_j_amt - $model[0]->sum_b_amt)."</strong></td>
							</tr>";
			}
			if ($model[0]->sum_b_t3 > $model[0]->sum_j_t3){
				$tc = $tc."
							<tr>
			...
			else if ($model[0]->sum_b_t3 < $model[0]->sum_j_t3){
				$tc = $tc."
							<tr>
								<td colspan=\"5\"><strong>Settlement Date T+".$model[0]->max_3plus."&emsp;".DateTime::createFromFormat('Y-m-d h:i:s',$model[0]->due_t3)->format('d/m/Y')." (".substr($model[0]->mrkt_t3,0,2).")</strong></td>
								<td style=\"text-align: right;\"></td>
								<td style=\"text-align: right;\"></td>
								<td style=\"text-align: right;\"><strong>Rp</strong></td>
								<td style=\"text-align: right;\"><strong>".(($model[0]->sum_j_t3 > $model[0]->sum_b_t3)?number_format($model[0]->sum_j_t3 - $model[0]->sum_b_t3) : '0')."</strong></td>
							</tr>";
			}
			
			if ($model[0]->sum_b_t2 > $model[0]->sum_j_t2){
				$tc = $tc."
							<tr>
			...
			else if ($model[0]->sum_b_t2 < $model[0]->sum_j_t2){
				$tc = $tc."
							<tr>
								<td colspan=\"5\"><strong>Settlement Date T+2&emsp;".DateTime::createFromFormat('Y-m-d h:i:s',$model[0]->due_t2)->format('d/m/Y')." (".substr($model[0]->mrkt_t2,0,2).")</strong></td>
								<td style=\"text-align: right;\"></td>
								<td style=\"text-align: right;\"></td>
								<td style=\"text-align: right;\"><strong>Rp</strong></td>
								<td style=\"text-align: right;\"><strong>".(($model[0]->sum_j_t2 > $model[0]->sum_b_t2)?number_format($model[0]->sum_j_t2 - $model[0]->sum_b_t2) : '0')."</strong></td>
							</tr>";
			}
			
			if($model[0]->sum_b_t1 > $model[0]->sum_j_t1){
				$tc = $tc."
							<tr>
			...
			if ($model[0]->sum_b_t1 < $model[0]->sum_j_t1){
				$tc = $tc."
							<tr>
								...
								<td style=\"text-align: right;\"></td>
								<td style=\"text-align: right;\"><strong>Rp</strong></td>
								<td style=\"text-align: right;\"><strong>".(($model[0]->sum_j_t1 > $model[0]->sum_b_t1)?number_format($model[0]->sum_j_t1 - $model[0]->sum_b_t1) : '0')."</strong></td>
							</tr>";
			}
			if ($model[0]->sum_b_t0 > $model[0]->sum_j_t0){
				$tc = $tc."
							<tr>
								<td colspan=\"5\"><strong>Settlement Date T+0&emsp;".DateTime::createFromFormat('Y-m-d h:i:s',$model[0]->contr_dt)->format('d/m/Y')." (".substr($model[0]->mrkt_t0,0,2).")</strong></td>
								<td style=\"text-align: right;\"><strong>Rp</strong></td>
			...
			if ($model[0]->sum_b_t0 < $model[0]->sum_j_t0){
				$tc = $tc."
							<tr>
								...
								<td style=\"text-align: right;\"></td>
								<td style=\"text-align: right;\"><strong>Rp</strong></td>
								<td style=\"text-align: right;\"><strong>".(($model[0]->sum_j_t0 > $model[0]->sum_b_t0)?number_format($model[0]->sum_j_t0 - $model[0]->sum_b_t0) : '0')."</strong></td>
							</tr>";
			}
			$tc = $tc."
			...
			if($model[0]->bank_rdi_acct){
						...
						$tc = $tc."<strong>".
						$model[0]->rdi_name."<br />
						".$model[0]->bank_rdi." : ".$model[0]->bank_rdi_acct."</strong>";
			}else{
				$tc = $tc."
			...
			if($model[0]->bank_rdi_acct){	
						if($model[0]->sum_j_amt > $model[0]->sum_b_amt){
							$tc = $tc."
								...
								<strong>".$model[0]->client_bank_name."<br />
								".$model[0]->client_bank." A/C : ".$model[0]->client_bank_acct."</strong>";
						}
			}
			$tc = $tc."
				</div>
			...
			<div>
				<div style=\"float: left; width: 60%;\">
					...
					".$model[0]->rem_name."
					<br /><br />
					In accordance with the Director General of Tax Regulation No. PER-33/PJ/2014,<br />
					Trade Confirmation is equated with a Tax Invoice
				</div>
				<div style=\"float: right; width: 40%;\">
					Confirmed by,<br />
					".$model[0]->nama_prsh."<br /><br />
					NPWP : ".$model[0]->no_ijin1."<br />
					PKP &emsp;: ".$model[0]->no_ijin1."<br /><br />
				</div>
			</div>
			<div style=\"clear: both; \">This is a computer generated advise. No signature is required.</div>
			";
		}else{
			$tc = "
		...
		if($model){
			...
			$tc = $tc."
							<tr style=\"background: #ECE8D8;border: 1.5px solid;\">
								...
								<td style=\"text-align: right;\"><strong>Rp</strong></td>
								<td style=\"text-align: right;\"><strong>".number_format($model[0]->sum_b_amt,0,',','.')."</strong></td>
								<td style=\"text-align: right;\"><strong>Rp</strong></td>
								<td style=\"text-align: right;\"><strong>".number_format($model[0]->sum_j_amt,0,',','.')."</strong></td>
							</tr>
							<tr><td colspan=\"9\"></td></tr>";
			if ($model[0]->sum_b_amt > $model[0]->sum_j_amt){
				$tc = $tc."
							<tr style=\"border-bottom: 1.5px solid;\">
								...
								<td style=\"text-align: right;\"><strong>Rp</strong></td>
								<td style=\"text-align: right;\"><strong>".number_format($model[0]->sum_b_amt - $model[0]->sum_j_amt,0,',','.')."</strong></td>
								<td style=\"text-align: right;\"></td>
								<td style=\"text-align: right;\"></td>
							</tr>";	
			}else{
				$tc = $tc."
							<tr style=\"border-bottom: 1.5px solid;\">
								...
								<td style=\"text-align: right;\"></td>
								<td style=\"text-align: right;\"><strong>Rp</strong></td>
								<td style=\"text-align: right;\"><strong>".number_format($model[0]->sum_j_amt - $model[0]->sum_b_amt,0,',','.')."</strong></td>
							</tr>";
			}
			if ($model[0]->sum_b_t3 > $model[0]->sum_j_t3){
				$tc = $tc."
			...
			else if ($model[0]->sum_b_t1 < $model[0]->sum_j_t1){
				$tc = $tc."
							<tr>
								<td colspan=\"5\"><strong>Settlement Date T+1&emsp;".DateTime::createFromFormat('Y-m-d h:i:s',$model[0]->due_t1)->format('d/m/Y')." (".substr($model[0]->mrkt_t1,0,2).")</strong></td>
								<td style=\"text-align: right;\"></td>
			...
			if ($model[0]->sum_b_t0 > $model[0]->sum_j_t0){
				$tc = $tc."
							<tr>
								<td colspan=\"5\"><strong>Tanggal Jatuh Tempo T+0&emsp;".DateTime::createFromFormat('Y-m-d h:i:s',$model[0]->contr_dt)->format('d/m/Y')." (".substr($model[0]->mrkt_t0,0,2).")</strong></td>
								<td style=\"text-align: right;\"><strong>Rp</strong></td>
								<td style=\"text-align: right;\"><strong>".(($model[0]->sum_b_t0 > $model[0]->sum_j_t0)?number_format($model[0]->sum_b_t0 - $model[0]->sum_j_t0) : '0')."</strong></td>
								<td style=\"text-align: right;\"></td>
								<td style=\"text-align: right;\"></td>
			...
			else if ($model[0]->sum_b_t0 < $model[0]->sum_j_t0){
				$tc = $tc."
							<tr>
								<td colspan=\"5\"><strong>Tanggal Jatuh Tempo T+0&emsp;".DateTime::createFromFormat('Y-m-d h:i:s',$model[0]->contr_dt)->format('d/m/Y')." (".substr($model[0]->mrkt_t0,0,2).")</strong></td>
								<td style=\"text-align: right;\"></td>
			...
			if($model[0]->bank_rdi_acct){	
						if($model[0]->sum_j_amt > $model[0]->sum_b_amt){
							$tc = $tc."
								...
								<strong>".$model[0]->client_bank_name."<br />
								".$model[0]->client_bank." : ".$model[0]->client_bank_acct."<strong>";
						}
			}
			$tc = $tc."
				</div>
			...
			<div>
				<div style=\"float: left; width: 60%;\">
					...
					".$model[0]->rem_name."
					<br /><br />
					Sesuai dengan Peraturan Direktur Jenderal Pajak Nomor PER-33/PJ/2014,
					Trade Confirmation ini dipersamakan dengan Faktur Pajak
				</div>
				<div style=\"float: right; width: 40%;\">
	...
	public function actionIndex()
	{
		...
		if(isset($_POST['Ttcdoc1']))
		{
			$model->attributes=$_POST['Ttcdoc1'];
					...
					if($valid)
					{
						...
						if($valid){
							...
							if($model->client_cd && $model->client_cd != '%'){
								$generatedtc = Ttcdoc1::model()->findAll(array('condition'=>"to_char(tc_date,'YYYY-MM-DD') = '$model->tc_date'
							...
							if($success){
								...
								//$this->redirect(array('/contracting/Ttcdoc1/index'));
							}else{
							//	$model->error_msg = 'Client tidak ditemukan!';
		...
		$msg = $model->error_code.' '.$model->error_msg;
	...
	public function actionTestgentc(){
		...
		$model= Rtradeconf::model()->findAll(array('condition'=>"client_cd = 'TOMM005R' and userid = 'ENDANG' ",'order'=>'stk_cd'));
		//$model2 = Rtradeconf::model()->findAll(array('condition'=>"client_cd = 'SARA005R' and userid = 'IN'"));
		$baseurl = Yii::app()->request->baseUrl;
		if($model){
			$tc = "
			<div>
	...
	public function actionAjxGetBrchList()
	{
		...
		{
			$tc_date = $_POST['tc_date'];
			$model = Ttcdoc1::model()->findAll(array('select'=>'DISTINCT brch_cd','condition'=>"tc_date = TO_DATE('$tc_date','DD/MM/YYYY') AND tc_status = 0",'order'=>'brch_cd'));
	...
	public function actionAjxGetRemList()
	{
		...
		{
			$tc_date = $_POST['tc_date'];
			$model = Ttcdoc1::model()->findAll(array('select'=>'DISTINCT rem_cd','condition'=>"tc_date = TO_DATE('$tc_date','DD/MM/YYYY') AND tc_status = 0",'order'=>'rem_cd'));
