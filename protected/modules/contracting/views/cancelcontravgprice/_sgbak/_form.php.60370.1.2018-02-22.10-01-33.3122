...
<table id='table-source' class='table table-bordered table-condensed'>
	...
	<tbody>
		...
		$avgprice = number_format(($totalqtyxprice / $totalqty),2);?>
	</tbody>
</table>
 <h4>To</h4>
 <?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="row-fluid">
		<div class="span6">
			<div class="control-group ">
				...
				<div class="controls">
					<input style="text-align: right" readonly="readonly" class="span6 tnumber" type="text" name="avg_price" maxlength="12" value="<?php echo $avgprice;?>" />
				</div>
			</div>
		</div>
	</div>
    ...
    <table border="0" cellspacing="0" cellpadding="0" id="table-total" class="table-condensed">
    	<tr>
	    	...
	    	<td style="width: 25%"; ><input id="txt_totqty" readonly="readonly" class="span tnumber" type="text" name="txt_totqty" maxlength="12" style="text-align: right;" value="<?php echo $totalqty;?>"></td>
    	...
    	<tr>
	    	...
	    	<td style="width: 25%"; ><input id="txt_remqty" readonly="readonly" class="span tnumber" type="text" name="txt_remqty" maxlength="12" style="text-align: right;" value="<?php echo ($trueqty-$totalqty);?>"></td>
	    	<!--<td style="width: 10%"></td>-->
	    	<td></td>
	    	<td></td>
    	</tr>
