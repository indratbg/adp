 ...
 <?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
        ...
        <thead>
   		...
   		<?php if($rowCount > $rowz){
			...
			<tr id="row_<?php echo $j;?>">
				...
				<td><?php echo $form->textField($model1[$j],'qty',array('onchange'=>'updqty();','style'=>'text-align: right;','class'=>'span tnumber','maxlength'=>12,'id'=>'Tcontracts_qty['.$j.']','name'=>'Tcontracts['.$j.'][qty]')); ?></td>
    ...
    <table border="0" cellspacing="0" cellpadding="0" id="table-total" class="table-condensed">
    	...
    	<tr>
	    	...
	    	<td style="width: 15%"; ><input id="txt_remqty" readonly="readonly" class="span tnumber" type="text" name="txt_remqty" maxlength="12" style="text-align: right;" value="<?php echo ($trueqty-$totalqty);?>"></td>
	    	<td style="width: 10%"></td>
	    	<td></td>
	    	<td></td>
    	</tr>
    ...
    <hr />
    <?php echo $form->textAreaRow($model[1],'cancel_reason',array('row'=>2,'class'=>'span6')); ?>
...
<?php $this->endWidget(); ?>
	<table class="hidden">
    	<tr id="clone_row" class="hidden">
			...
			<td><?php echo $form->datePickerRow($model[1],'due_dt_for_amt',array('value'=>'','label'=>false, 'prepend'=>'<i class="icon-calendar"></i>','placeholder'=>'dd/mm/yyyy','class'=>'tdate span','options'=>array('format' => 'dd/mm/yyyy'))); ?></td>
       		<td style="text-align: center"><?php echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl.'/images/delete.png', 'Delete'), 'javascript://', array('class'=>'delete-detail','onclick'=>'deleteRow(this);')); ?></td>
       </tr>
   </table>
