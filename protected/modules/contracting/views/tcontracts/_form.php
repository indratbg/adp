 ...
 <?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
        ...
        <thead>
   		...
   		<?php if($rowCount > 0){
			...
			<tr id="row_<?php echo $j;?>">
	       		<td><?php echo $form->dropDownList($model1[$j],'client_cd',CHtml::listData(Client::model()->findAll(array('condition'=>"SID like '$sid'",'order'=>'client_cd')), 'client_cd', 'ConcatForSettlementClientCmb'),
				...
				<td><?php echo $form->datePickerRow($model1[$j],'due_dt_for_amt',array('label'=>false, 'prepend'=>'<i class="icon-calendar"></i>','placeholder'=>'dd/mm/yyyy','class'=>'tdate span',
    ...
    <table border="0" cellspacing="0" cellpadding="0" id="table-total" class="table-condensed">
    	...
    	<tr>
	    	...
	    	<td style="width: 15%"; ><input id="txt_remqty" readonly="readonly" class="span tnumber" type="text" name="txt_remqty" maxlength="12" style="text-align: right;" value="<?php echo ($model->qty-$totalqty);?>"></td>
	    	<td style="width: 10%"></td>
	    	<td></td>
	    	<td></td>
    	</tr>
...
<?php $this->endWidget(); 
	...
	<table class="hidden">
    	<tr id="clone_row" class="hidden">
       		<td><?php echo $form->dropDownList($model,'client_cd',CHtml::listData(Client::model()->findAll(array('condition'=>"SID like '$sid'",'order'=>'client_cd')), 'client_cd', 'ConcatForSettlementClientCmb')
			...
			<td><?php echo $form->datePickerRow($model,'due_dt_for_amt',array('value'=>'','label'=>false, 'prepend'=>'<i class="icon-calendar"></i>','placeholder'=>'dd/mm/yyyy','class'=>'tdate span','options'=>array('format' => 'dd/mm/yyyy'))); ?></td>
       		<td style="text-align: center"><?php echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl.'/images/delete.png', 'Delete'), 'javascript://', array('class'=>'delete-detail','onclick'=>'deleteRow(this);')); ?></td>
       </tr>
   </table>
