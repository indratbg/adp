...
$this->menu=array(
	array('label'=>'Generate IM File', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px;margin-top:8px;')),
...
<div class="row-fluid">
	...
	<div class="control-group">
        <div class="span5">
            <?php echo $form->dropDownListRow($model,'im_code',CHtml::listData($im_code, 'im_code', 'im_name'),array('class'=>'span8','prompt'=>'-Select-','style'=>'font-family:courier'));?>
    </div>
