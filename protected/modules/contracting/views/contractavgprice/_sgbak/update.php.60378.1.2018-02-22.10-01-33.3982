...
<?php echo $this->renderPartial('_form',array('model'=>$model,'model1'=>$model1,'totalqty'=>$totalqty,'trueqty'=>$trueqty,'rowz'=>$rowz,'rowCount'=>$rowCount,'maxduedtforamt'=>$maxduedtforamt,'avgprice'=>$avgprice)); ?>