...
class TreksnabController extends AAdminController
{
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Treksnab::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Treksnab::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail  = Treksnab::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Treksnab();
