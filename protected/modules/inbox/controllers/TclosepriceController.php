...
{
    public $table_name = 'T_CLOSE_PRICE';
    ...
    public function actionView($id)
    {
        ...
        if($model->status == AConstant::INBOX_STAT_UPD){
            $modelDetail     = Tcloseprice::model()->find("rowid ='$model->table_rowid'"); // left
            $modelDetailUpd  = Tcloseprice::model()->find("rowid ='$model->table_rowid'"); // right [updated version]
            ...
            if($model->status == AConstant::INBOX_STAT_CAN){
                $modelDetail     = Tcloseprice::model()->find("rowid ='$model->table_rowid'"); 
            }else{
                $modelDetail  = new Tcloseprice();
