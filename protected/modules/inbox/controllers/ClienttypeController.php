...
{
	public $table_name = 'MST_CLIENT_TYPE';
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Clienttype::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Clienttype::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail  = Clienttype::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Clienttype();
