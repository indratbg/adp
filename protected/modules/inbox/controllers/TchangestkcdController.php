...
{
	public $table_name = 'T_CHANGE_STK_CD';
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Tchangestkcd::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Tchangestkcd::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail     = Tchangestkcd::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Tchangestkcd();
