...
{
	public $table_name = 'T_PORTO_JAMINAN';
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = tportojaminan::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = tportojaminan::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail  = tportojaminan::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new tportojaminan();
