...
{
	public $table_name = 'T_CORP_GUARANTEE';
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Tcorpguarantee::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Tcorpguarantee::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail  = Tcorpguarantee::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Tcorpguarantee();
