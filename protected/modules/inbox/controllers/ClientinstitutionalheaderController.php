...
class ClientinstitutionalheaderController extends AAdminController
{
	public $table_name = 'MST_CIF';
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Cif::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Cif::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail     = Cif::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Cif();
