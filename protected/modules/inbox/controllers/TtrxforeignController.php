...
{
	public $table_name = 'T_TRX_FOREIGN';
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Ttrxforeign::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Ttrxforeign::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail  = Ttrxforeign::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Ttrxforeign();
