...
{
	public $table_name = 'T_BOND_PRICE';
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Tbondprice::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Tbondprice::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail  = Tbondprice::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Tbondprice();
