...
{
	public $table_name = 'MST_GL_ACCOUNT';
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Glaccount::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Glaccount::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail  = Glaccount::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Glaccount();
