...
{
	public $table_name = 'MST_MAP_NERACA_RINGKAS';
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Groupneraca::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Groupneraca::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail  = Groupneraca::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Groupneraca();
