...
class CompanyController extends AAdminController
{
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Company::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Company::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail     = Company::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Company();
