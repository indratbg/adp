...
class TexchrateController extends AAdminController
{
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Texchrate::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Texchrate::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail  = Texchrate::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Texchrate();
