...
{
	public $table_name = 'MST_FIXED_ASSET';
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Fixedasset::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Fixedasset::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail  = Fixedasset::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Fixedasset();
