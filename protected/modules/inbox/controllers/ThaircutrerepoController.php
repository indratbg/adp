...
{
	public $table_name = 'T_HAIRCUT_REREPO';
	...
	public function actionView($id)
	{
		...
		if($model->status == AConstant::INBOX_STAT_UPD){
			$modelDetail     = Thaircutrerepo::model()->find("rowid ='$model->table_rowid'");	// left
			$modelDetailUpd  = Thaircutrerepo::model()->find("rowid ='$model->table_rowid'");	// right [updated version]
			...
			if($model->status == AConstant::INBOX_STAT_CAN){
				$modelDetail  = Thaircutrerepo::model()->find("rowid ='$model->table_rowid'");	
			}else{
				$modelDetail  = new Thaircutrerepo();
