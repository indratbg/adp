		...
		'actionButtons' => array(
			...
			array(
				...
				'click' => 'js:function(checked_element){
						...
						showPopupModal("Reject Reason","'.(Yii::app()->getBaseUrl(true).'/index.php?r=inbox/Tfundmovement/AjxPopRejectChecked').'"+temp);	
				}'
			)
		),
		...
		array(
			...
			'buttons'=>array(
		          'view'=>array(
		        	'label'=>'view', 
		            'icon' =>'eye-open',                          
		            'url'  =>'Yii::app()->createUrl("/inbox/Tfundmovement/view", array("id" => $data->update_seq))',				// AH : change 
		         ),
			   
			    'approve'=>array(
		        	'label'=>'approve', 
		            'icon' =>'ok',                          
		            'url'  =>'Yii::app()->createUrl("/inbox/Tfundmovement/approve", array("id" => $data->update_seq))',				// AH : change 
		        	'click' => 'js:function(e){
		        		e.preventDefault();	
						$.ajax({
							type    :"POST",
		         ...
		         'reject'=>array(
		         	'label'=>'reject',
		            'icon'=> 'remove',
		            'url' => 'Yii::app()->createUrl("/inbox/Tfundmovement/AjxPopReject", array("id" => $data->update_seq))',			// AH : change
		            'click'=>'js:function(e){
		            	e.preventDefault();
