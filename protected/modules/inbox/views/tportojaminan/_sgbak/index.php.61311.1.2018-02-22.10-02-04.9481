...
$this->breadcrumbs=array(
	'Portofolio yang Dijaminkan  Inbox'=>array('index'),
	'Unprocessed Client IPO Stock',
);

$this->menu=array(
	array('label'=>'Portofolio yang Dijaminkan Inbox', 'itemOptions'=>array('class'=>'nav-header')),
	...
	array('label'=>'List','url'=>Yii::app()->request->baseUrl.'?r=custody/tportojaminan/index','icon'=>'list'),
);
...
<h1>Unprocessed Portofolio yang Dijaminkan</h1>
		...
		'actionButtons' => array(
			...
			array(
				...
				'click' => 'js:function(checked_element){
						...
						showPopupModal("Reject Reason","'.(Yii::app()->getBaseUrl(true).'/index.php?r=inbox/Tportojaminan/AjxPopRejectChecked').'"+temp);	
				}'
			)
		),
		...
		array(
			...
			'buttons'=>array(
		        'approve'=>array(
		        	'label'=>'approve', 
		            'icon' =>'ok',                          
		            'url'  =>'Yii::app()->createUrl("/inbox/Tportojaminan/approve", array("id" => $data->primaryKey))',				// AH : change 
		         ),
		         'reject'=>array(
		         	'label'=>'reject',
		            'icon'=> 'remove',
		            'url' => 'Yii::app()->createUrl("/inbox/Tportojaminan/AjxPopReject", array("id" => $data->primaryKey))',			// AH : change
		            'click'=>'js:function(e){
		            	e.preventDefault();
