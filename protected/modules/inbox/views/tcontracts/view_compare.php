	...
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
				...
				'client.client_name',
				'mrkt_type',
				isset($modelDetail->sell_broker_cd)<>NULL? 'sell_broker_cd':'buy_broker_cd',
				//'buy_broker_cd',
				//'buybroker.client_name',
				array('name'=>'brok_perc', 'value'=>$modelDetail->brok_perc/100),
				array('name'=>'gain_loss_amt', 'value'=>$modelDetail->gain_loss_amt/100),
			),
		)); ?>
	</div>
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
				'contr_num',
				array('label'=>'Beli / Jual', 'value'=>substr($modelDetailUpd->contr_num,4,1)),
				array('name'=>'contr_dt','type'=>'date'),
				array('name'=>'due_dt_for_amt','type'=>'date'),
				'stk_cd',
				'counter.stk_desc',
				...
				'client.client_name',
				'mrkt_type',
				isset($modelDetailUpd->sell_broker_cd)<>NULL? 'sell_broker_cd':'buy_broker_cd',
				//'buy_broker_cd',
				//'buybroker.client_name',
				array('name'=>'brok_perc', 'value'=>$modelDetailUpd->brok_perc/100),
				array('name'=>'gain_loss_amt', 'value'=>$modelDetailUpd->gain_loss_amt/100),
			),
		)); ?>
	</div>
 </div>
