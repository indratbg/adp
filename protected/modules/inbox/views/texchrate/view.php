...
<h1>View Foreign Currency - Exchange Rate Inbox #<?php echo $model->update_seq; ?></h1>

<?php AHelper::showFlash($this) ?> <!-- show flash -->

<h4>Data Exchange Rate</h4> 

<?php $this->widget('bootstrap.widgets.TbDetailView',array(
	'data'=>$modelDetail,
	'attributes'=>array(
		array('name'=>'exch_dt','type'=>'date'),
		'curr_cd',
		array('name'=>'rate','value'=>number_format((float) $modelDetail->rate,0,'.',',')),
	),
)); ?>
