...
$this->breadcrumbs=array(
	'Foreign Currency - Exchange Rate'=>array('index'),
	'Unprocessed Foreign Currency - Exchange Rate Inbox',
);

$this->menu=array(
	array('label'=>'Foreign Currency - Exchange Rate Inbox', 'itemOptions'=>array('class'=>'nav-header')),
...
<h1>Unprocessed Foreign Currency - Exchange Rate</h1>
		...
		'actionButtons' => array(
			...
			array(
				...
				'click' => 'js:function(checked_element){
						...
						showPopupModal("Reject Reason","'.(Yii::app()->getBaseUrl(true).'/index.php?r=inbox/Texchrate/AjxPopRejectChecked').'"+temp);	
				}'
			)
		),
		...
		array(
			...
			'buttons'=>array(
		        'approve'=>array(
		        	'label'=>'approve', 
		            'icon' =>'ok',                          
		            'url'  =>'Yii::app()->createUrl("/inbox/Texchrate/approve", array("id" => $data->primaryKey))',				// AH : change 
		         ),
		         'reject'=>array(
		         	'label'=>'reject',
		            'icon'=> 'remove',
		            'url' => 'Yii::app()->createUrl("/inbox/Texchrate/AjxPopReject", array("id" => $data->primaryKey))',			// AH : change
		            'click'=>'js:function(e){
		            	e.preventDefault();
