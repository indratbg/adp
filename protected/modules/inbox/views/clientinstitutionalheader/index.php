...
$this->breadcrumbs=array(
	'Clientinstitutionalheader Inbox'=>array('index'),
	'Unprocessed',
);

$this->menu=array(
	array('label'=>'Clientinstitutionalheader Inbox', 'itemOptions'=>array('class'=>'nav-header')),
...
<h1>Unprocessed Clientinstitutionalheader</h1>
		...
		'actionButtons' => array(
			...
			array(
				...
				'click' => 'js:function(checked_element){
						...
						showPopupModal("Reject Reason","'.(Yii::app()->getBaseUrl(true).'/index.php?r=inbox/Clientinstitutionalheader/AjxPopRejectChecked').'"+temp);	
				}'
			)
		),
		...
		array(
			...
			'buttons'=>array(
		        'approve'=>array(
		        	'label'=>'approve', 
		            'icon' =>'ok',                          
		            'url'  =>'Yii::app()->createUrl("/inbox/Clientinstitutionalheader/approve", array("id" => $data->primaryKey))',				// AH : change 
		         ),
		         'reject'=>array(
		         	'label'=>'reject',
		            'icon'=> 'remove',
		            'url' => 'Yii::app()->createUrl("/inbox/Clientinstitutionalheader/AjxPopReject", array("id" => $data->primaryKey))',			// AH : change
		            'click'=>'js:function(e){
		            	e.preventDefault();
