...
$this->breadcrumbs=array(
	'Deposit  Inbox'=>array('index'),
	$model->update_seq,
);

$this->menu=array(
	array('label'=>'Deposit Inbox', 'itemOptions'=>array('class'=>'nav-header')),
...
<h1>View Deposit Inbox #<?php echo $model->update_seq; ?></h1>
...
<div class="row-fluid">
	...
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
				'ref_num',
				array('name'=>'bank','value'=>Ipbank::model()->find("approved_stat = 'A' AND bank_cd ='$modelDetailUpd->bank_cd'")->bank_name),
				'bank_branch',
				array('name'=>'type','value'=>Parameter::model()->find("prm_cd_1 = 'BANKTY' AND prm_cd_2 ='$modelDetailUpd->bank_type'")->prm_desc),
				array('name'=>'from_dt','type'=>'date'),
				array('name'=>'to_dt','type'=>'date'),
				array('name'=>'amount','type'=>'number'),
				array('name'=>'jaminan_lps','type'=>'number'),
