...
<?php echo $form->textFieldRow($modelParentDetailCurr,'client_cd',array('class'=>'span5','readonly'=>'readonly','label'=>false)) ?>
	</div>
		<div class="span8">
			<div class="span2" style="margin-right:-3px">
				<?php echo $form->label($modelParentDetailCurr,'client_name',array('class'=>'control-label','style'=>'font-weight:bold')) ?>
			</div>
			<?php echo $form->textFieldRow($modelParentDetailCurr,'client_name',array('class'=>'span5','readonly'=>'readonly','label'=>false)) ?>
</div>
</div>
...
<div class="row-fluid">
	<div class="span4">
		<?php echo $form->label($modelParentDetailCurr,'branch_code',array('class'=>'control-label','style'=>'font-weight:bold')) ?>
		<?php echo $form->textFieldRow($modelParentDetailCurr,'branch_code',array('class'=>'span3','readonly'=>'readonly','label'=>false)) ?>
	</div>
	<div class="span8">
		<div class="span1">
		...
		<div class="span2">
	<?php echo $form->textFieldRow($modelParentDetailCurr,'client_type',array('class'=>'span','readonly'=>'readonly','label'=>false,'value'=>$modelParentDetailCurr->client_type_1.$modelParentDetailCurr->client_type_2.$modelParentDetailCurr->client_type_3)) ?>
	</div>
	<?php echo $form->textFieldRow($modelParentDetailCurr,'Client Type',array('class'=>'span4','readonly'=>'readonly','label'=>false,'value'=>Lsttype3::model()->find("cl_type3 = '$modelParentDetailCurr->client_type_3'")->cl_desc)); ?>
</div>
...
<div class="row-fluid">
	<div class="span4">
		<?php echo $form->label($modelParentDetailCurr,'Calculation Mode',array('class'=>'control-label','style'=>'font-weight:bold')) ?>
		<?php echo $form->textFieldRow($modelParentDetailCurr,'amt_int_flg',array('class'=>'span4','readonly'=>'readonly','label'=>false,'value'=>$modelParentDetailCurr->amt_int_flg=='N'?'Manual':'System')) ?>
</div>
	<div class="span4">
		<div class="span4">
			<label class="control-label" style="font-weight:bold">PPH</label>
		</div>
		<?php echo $form->textFieldRow($modelParentDetailCurr,'tax_on_interest',array('class'=>'span3','readonly'=>'readonly','label'=>false,'value'=>$modelParentDetailCurr->tax_on_interest=='Y'?'Yes':'No')) ?>
...
<div class="row-fluid">
	<div class="span4">
		...
		<?php echo $form->textFieldRow($modelParentDetailCurr,'int_rec_days',array('class'=>'span3','readonly'=>'readonly','label'=>false,'style'=>'text-align:right')); ?>
	</div>
	<div class="span4">
		<div class="span4">
			<label class="control-label" style="font-weight:bold">AP%</label>
		</div>
	<?php echo $form->textFieldRow($modelParentDetailCurr,'int_pay_days',array('class'=>'span3','readonly'=>'readonly','label'=>false,'style'=>'text-align:right')); ?>
	</div>
</div>
...
<h4>Data Interest Rate(Updated)</h4>
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	'id'=>'bankMaster',
	'enableAjaxValidation'=>false,
	'type'=>'horizontal'
