...
$this->breadcrumbs=array(
	...
	'Unprocessed Laporan Rincian Portofolio',
);

$this->menu=array(

	array('label'=>'Processed Laporan Rincian Portofolio', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px;margin-top:8px;')),
