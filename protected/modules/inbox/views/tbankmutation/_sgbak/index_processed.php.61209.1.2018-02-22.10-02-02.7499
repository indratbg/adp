...
$this->breadcrumbs=array(
	...
	'Processed Upload Rekening Dana Mutation',
);

$this->menu=array(

	array('label'=>'Processed Upload Rekening Dana Mutation', 'itemOptions'=>array('style'=>'font-size:28px;font-weight:bold;color:black;margin-left:-17px;margin-top:8px;')),
