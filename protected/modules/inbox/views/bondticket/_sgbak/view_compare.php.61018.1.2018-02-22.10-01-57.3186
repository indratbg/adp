...
<h1>View Bond Transaction Ticket Name Inbox #<?php echo $model->update_seq; ?></h1>

<?php AHelper::showFlash($this) ?> <!-- show flash -->

<h4>Data Bond Transaction Ticket Name</h4>
<div class="row-fluid">
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
				...
				'price',
				array('name'=>'net_amount','value'=>number_format($modelDetail->net_amount,0)),
				'trx_id_yymm'
	...
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array( 
		    ...
		    'attributes'=>array( 
				...
				'lawan',
				'bond_cd',
				array('name'=>'nominal','value'=>number_format($modelDetailUpd->nominal,0)),
				'price',
				array('name'=>'net_amount','value'=>number_format($modelDetailUpd->net_amount,0)),
				'trx_id_yymm'
			    ), 
			)); ?>
	 </div>
