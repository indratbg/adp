...
$this->breadcrumbs=array(
	'Bond Transaction Ticket Inbox'=>array('index'),
	'Unprocessed Bond Transaction Ticket',
);

$this->menu=array(
	array('label'=>'Bond Transaction Ticket Inbox', 'itemOptions'=>array('class'=>'nav-header')),
	...
	array('label'=>'List','url'=>Yii::app()->request->baseUrl.'?r=glaccounting/bondticket/index','icon'=>'list'),
);
...
<h1>Unprocessed Bond Transaction Ticket Names</h1>
		...
		'actionButtons' => array(
			...
			array(
				...
				'click' => 'js:function(checked_element){
						...
						showPopupModal("Reject Reason","'.(Yii::app()->getBaseUrl(true).'/index.php?r=inbox/bondticket/ajxpoprejectchecked').'"+temp);	
				}'
			)
		),
		...
		array(
			...
			'buttons'=>array(
		        'approve'=>array(
		        	'label'=>'approve', 
		            'icon' =>'ok',                          
		            'url'  =>'Yii::app()->createUrl("/inbox/bondticket/approve", array("id" => $data->primaryKey))',				// AH : change 
		         ),
		         'reject'=>array(
		         	'label'=>'reject',
		            'icon'=> 'remove',
		            'url' => 'Yii::app()->createUrl("/inbox/bondticket/ajxpopreject", array("id" => $data->primaryKey))',			// AH : change
		            'click'=>'js:function(e){
		            	e.preventDefault();
