...
<h1>View IDX Holiday Inbox #<?php echo $model->update_seq; ?></h1>

<?php AHelper::showFlash($this) ?> <!-- show flash -->

<h4>Data IDX Holiday</h4> 
<div class="row-fluid">
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
				...
				array('name'=>'ket_libur','type'=>'raw','value'=>nl2br($modelDetail->ket_libur)),
				'flag_libur',
			),
		)); ?>
	</div>
	<div class="span6">
		<?php 
			$this->widget('bootstrap.widgets.TbDetailView',array( 
			    ...
			    'attributes'=>array( 
			    	array('name'=>'tgl_libur','type'=>'date'),
					array('name'=>'ket_libur','type'=>'raw','value'=>nl2br($modelDetailUpd->ket_libur)),
					'flag_libur',
			    ), 
			)); ?>
	 </div>
