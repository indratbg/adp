...
<h1>View Penyertaan Reksa dana Inbox #<?php echo $model->update_seq; ?></h1>

<?php AHelper::showFlash($this) ?> <!-- show flash -->

<h4>Data Penyertaan Reksa dana</h4>
<div class="row-fluid">
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'trx_type',
			array('name'=>'subs','value'=>number_format((float) $modelParentDetailCurr->subs,0,'.',',')),
			array('name'=>'redm','value'=>number_format((float) $modelParentDetailCurr->redm,0,'.',',')),
			'gl_a1',
			'sl_a1',
			'gl_a2',
			'sl_a2',
	...
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			array('name'=>'trx_date','type'=>'date'),
			'trx_type',
			array('name'=>'subs','value'=>number_format((float) $modelParentDetail->subs,0,'.',',')),
			array('name'=>'redm','value'=>number_format((float) $modelParentDetail->redm,0,'.',',')),
			'gl_a1',
			'sl_a1',
			'gl_a2',
			'sl_a2',
