...
$this->breadcrumbs=array(
	...
	'Processed Interest Journal Entry',
);

$this->menu=array(

	array('label'=>'Processed Interest Journal Entry', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px;margin-top:8px;')),
