...
$this->menu=array(
	...
	array('label'=>'List','url'=>Yii::app()->request->baseUrl.'?r=fixedincome/tbondtrx/index','icon'=>'list'),
);
...
<h1>Unprocessed Bond Transactions</h1>
...
<?php $this->widget('bootstrap.widgets.TbExtendedGridView',array(
		...
		'actionButtons' => array(
			...
			array(
				...
				'click' => 'js:function(checked_element){
						...
						showPopupModal("Reject Reason","'.(Yii::app()->getBaseUrl(true).'/index.php?r=inbox/tbondtrx/AjxPopRejectChecked').'"+temp);	
				}'
			)
		),
	...
	'columns'=>array(
		...
		array(
			...
			'buttons'=>array(
				'view'=>array(
						'url' =>'Yii::app()->createUrl("/inbox/tbondtrx/view", array("update_date"=>$data->update_date,"update_seq"=>$data->update_seq))',
					),
		        'approve'=>array(
		        	'label'=>'approve', 
		            'icon' =>'ok',                          
		            'url'  =>'Yii::app()->createUrl("/inbox/tbondtrx/approve", array("id" => $data->primaryKey))',				// AH : change 
		         ),
		         'reject'=>array(
		         	'label'=>'reject',
		            'icon'=> 'remove',
		            'url' => 'Yii::app()->createUrl("/inbox/tbondtrx/AjxPopReject", array("id" => $data->primaryKey))',			// AH : change
		            'click'=>'js:function(e){
		            	e.preventDefault();
