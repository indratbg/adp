...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'client_name',
		...
		array(
			...
			'buttons'=>array(
		        'english'=>array(
		        	'url' => 'Yii::app()->createUrl("inbox/ttcdoc/previewtceng&tc_date=".$data->tc_date."&tc_id=".$data->tc_id."&client_cd=".$data->client_cd."&tc_rev=".$data->tc_rev)',			// AH : change
		            'label'=>'English',
		        ...
		        'indonesia'=>array(
		        	'url' => 'Yii::app()->createUrl("inbox/ttcdoc/previewtcind&tc_date=".$data->tc_date."&tc_id=".$data->tc_id."&client_cd=".$data->client_cd."&tc_rev=".$data->tc_rev)',			// AH : change
		            'label'=>'Indonesia',
		           	'options' => array(  // set all kind of html options in here
