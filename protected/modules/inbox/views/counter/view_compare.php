		...
		<?php 
			$this->widget('bootstrap.widgets.TbDetailView',array( 
			    ...
			    'attributes'=>array( 
					...
					array('name'=>'indry_type','value'=>Parameter::getParamDesc('INDRYT',$modelDetailUpd->indry_type)),
					...
					array('name'=>'pp_from_dt','type'=>'date'),
					array('name'=>'pp_to_dt','type'=>'date'),
					array('name'=>'regr_cd','value'=>Parameter::getParamDesc('REGRCD',$modelDetailUpd->regr_cd)),
					array('name'=>'stk_lisd_dt','type'=>'date'),
