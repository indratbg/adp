...
<h1>View Haircut MKBD Inbox #<?php echo $model->update_seq; ?></h1>

<?php AHelper::showFlash($this) ?> <!-- show flash -->

<h4>Data Haircut MKBD</h4>
<div class="row-fluid">
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
				...
				'stk_cd',
				array('name'=>'haircut','value'=>number_format((float)$modelDetail->haircut,0,'.',',')),
	...
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
					array('name'=>'status_dt','type'=>'date'),
					'stk_cd',
					array('name'=>'haircut','value'=>number_format((float)$modelDetailUpd->haircut,0,'.',',')),
					array('name'=>'eff_dt','type'=>'date'),
			),
		)); ?>
	</div>
