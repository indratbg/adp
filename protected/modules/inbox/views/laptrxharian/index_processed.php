...
$this->breadcrumbs=array(
	...
	'Unprocessed Laporan Transaksi Harian BEI',
);

$this->menu=array(

	array('label'=>'Processed Laporan Transaksi Harian BEI', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px;margin-top:8px;')),
