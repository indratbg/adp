	...
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
					...
					'jenis_trx',
					'currency_type',
					array('name'=>'nilai_rph','value'=>number_format((float) $modelDetailUpd->nilai_rph,0,'.',',')),
					array('name'=>'untung_unreal','value'=>number_format((float) $modelDetailUpd->untung_unreal,0,'.',',')),
					array('name'=>'rugi_unreal','value'=>number_format((float) $modelDetailUpd->rugi_unreal,0,'.',',')),
			),
		)); ?>
	</div>
 </div>
