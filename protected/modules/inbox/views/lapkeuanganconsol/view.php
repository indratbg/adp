...
$this->menu=array(
	array('label'=>'View Laporan Transaksi Harian BEI Inbox ', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px;margin-top:8px;')),
...
<h4>Laporan Transaksi Harian BEI</h4> 
...
<table id='tableAcct' class='table table-bordered table-condensed' style="width: 100%">
	<thead>
		<tr>
			...
			<th width="80px">Beli</th>
			<th width="30px">Jual</th>
	...
	?>
		...
		<tr id="row<?php echo $x ?>">
			...
			<td style="text-align: right">
				<?php echo number_format((float)$row->beli,2,'.',',' )?>
			</td style="text-align: right">
			<td style="text-align: right">	<?php echo number_format((float)$row->jual,2,'.',',' )?></td>
		<!--	<td style="text-align: right">
				<?php //echo AConstant::$inbox_stat[$listTmanyChildDetail[$x-1][0]->upd_status] ?>
				<?php //echo number_format((float)$row->beli + $row->jual,2,'.',',' ) ?>
		</td>-->
		</tr>
	<?php $x++;} ?>
	</tbody>
