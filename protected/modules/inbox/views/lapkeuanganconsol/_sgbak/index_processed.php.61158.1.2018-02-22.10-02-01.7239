...
$this->menu=array(
	...
	array('label'=>'Processed Laporan Keuangan Konsolidasi', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px;margin-top:8px;')),
