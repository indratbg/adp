...
<div class="row-fluid">
	...
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'client_name',
			'branch_code',
			array('name'=>'susp_stat','value'=>Constanta::$sups_stat[$modelDetailUpd->susp_stat]),
			'susp_trx'
...
<?php if($model->approved_status == AConstant::INBOX_APP_STAT_ENTRY): ?>	
	...
	<div style="text-align:right;">
		<?php $this->widget('bootstrap.widgets.TbButton', array(
			...
			'htmlOptions'=>array('class'=>'approve-inbox'),
			'label'=>'Approve',
		)); ?>
		<?php $this->widget('bootstrap.widgets.TbButton', array(
			'type'=>'secondary',
...
$param  = array(array('class'=>'reject-inbox','title'=>'Reject Reason','url'=>'AjxPopReject','urlparam'=>array('id'=>$model->primaryKey,'label'=>false)),
	array('class'=>'approve-inbox','title'=>'Approve Reason','url'=>'Approve','urlparam'=>array('id'=>$model->primaryKey,'label'=>false)
