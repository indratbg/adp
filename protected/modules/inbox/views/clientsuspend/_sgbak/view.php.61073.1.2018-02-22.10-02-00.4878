...
<?php $format = new CFormatter;
 ...
 ?>
<h1>View Suspend/Re-activate Client Account Inbox #<?php echo $model->update_seq; ?></h1>

<?php AHelper::showFlash($this) ?> <!-- show flash -->

<h4>Data Suspend/Re-activate Client Account</h4> 
...
<?php $this->widget('bootstrap.widgets.TbDetailView',array(
	...
	'attributes'=>array(
		'client_cd',
			'client_name',
			'branch_code',
			array('name'=>'susp_stat','value'=>Constanta::$sups_stat[$modelDetail->susp_stat]),
			'susp_trx'
	...
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
				...
				'approved_user_id',
				array('name'=>'Reason','type'=>'raw','value'=>nl2br($model->reject_reason)),
			),
		)); ?>
	</div>
</div>
