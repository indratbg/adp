...
<h1>View Rekening Dana Inbox #<?php echo $model->update_seq; ?></h1>

<?php AHelper::showFlash($this) ?> <!-- show flash -->

<h4>Data Rekening Dana</h4> 
<div class="row-fluid">
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
				...
				'acct_name',
				//'acct_stat',
				array('name'=>'acct_stat','value'=>AConstant::$acct_stat[$modelDetail->acct_stat]),
				'bank_short_name',
				'bank_acct_fmt',
		...
		<?php 
			$this->widget('bootstrap.widgets.TbDetailView',array( 
			    ...
			    'attributes'=>array( 
					...
					'acct_name',
					//'acct_stat',
					array('name'=>'acct_stat','value'=>AConstant::$acct_stat[$modelDetailUpd->acct_stat]),
					'bank_short_name',
					'bank_acct_fmt',
					array('name'=>'from_dt','type'=>'date'),
					array('name'=>'to_dt','type'=>'date'),
