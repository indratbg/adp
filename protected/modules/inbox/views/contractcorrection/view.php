...
<table id='table-data' class='table table-bordered table-condensed'>
	...
	<tbody>
		<tr id="row1">
			...
			<td><?php echo AConstant::$contract_belijual[substr($modelDetailCancel->contr_num,4,1)]?></td>
			...
			<td style="text-align: right;"><?php echo number_format($modelDetailCancel->price,0);?></td>
			<td style="text-align: right;"><?php echo $modelDetailCancel->brok_perc/100;?></td>
			<td><?php echo DateTime::createFromFormat('Y-m-d',$modelDetailCancel->due_dt_for_amt)->format('d M Y');?></td>
