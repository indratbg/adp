...
<div class="row-fluid">
	...
	<div class="span4">
		...
		<?php echo $form->textFieldRow($modelParentDetail,'repo_date',array('readonly'=>'readonly','label'=>false,'class'=>'span5','value'=>$model->status=='U'?$modelParentDetail->repo_date:Tmanydetail::reformatDate($modelParentDetail->repo_date))) ?>
	</div>
</div>
...
<div class="row-fluid">
	...
	<div class="span4">
		<?php echo $form->label($modelParentDetail,'Tanggal',array('class'=>'control-label','style'=>'font-weight:bold')) ?>
		<?php echo $form->textFieldRow($modelParentDetail,'extent_dt',array('readonly'=>'readonly','label'=>false,'class'=>'span5','value'=>$model->status=='U'?$modelParentDetail->extent_dt:Tmanydetail::reformatDate($modelParentDetail->extent_dt))) ?>
	</div>
	<div class="span4" style="width:200px">
		...
		<?php echo $form->textFieldRow($modelParentDetail,'due_date',array('readonly'=>'readonly','label'=>false,'class'=>'span8','value'=>$model->status=='U'?$modelParentDetail->due_date:Tmanydetail::reformatDate($modelParentDetail->due_date))) ?>
	</div>
</div>
