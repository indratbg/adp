...
<h1>View Corporate Guarantee Inbox #<?php echo $model->update_seq; ?></h1>

<?php AHelper::showFlash($this) ?> <!-- show flash -->

<h4>Data Corporate Guarantee</h4>
<div class="row-fluid">
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'id'=>'tablecompare',
			'attributes'=>array(
				array('name'=>'contract_dt','type'=>'date'),
				array('name'=>'end_contract_dt','type'=>'date'),
				'guaranteed',
				'afiliasi',
				'rincian',
				'jangka',
