...
<h1>View High Risk Name Inbox #<?php echo $model->update_seq; ?></h1>

<?php AHelper::showFlash($this) ?> <!-- show flash -->

<h4>Data High Risk Name</h4> 
<?php if(sizeof($modelDetail) == 1){?>
	...
	<table id='table-data' class='table table-bordered table-condensed'>
		...
		?>
			<tr id="row<?php echo $x ?>">
				...
				<td><?php echo $row->ref_date?DateTime::createFromFormat('Y/m/d H:i:s',$row->ref_date)->format('d M Y') : '';?></td>
			</tr>
		<?php $x++;}} ?>
		</tbody>
	</table>
