...
<h1>View Group Emitent Inbox #<?php echo $model->update_seq; ?></h1>

<?php AHelper::showFlash($this) ?> <!-- show flash -->

<h4>Data Group Emitent</h4>
<div class="row-fluid">
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
				...
				'stk_cd',
				'grp_emi',
				array('name'=>'grp_type','value'=>AConstant::$grp_type_emitent[$modelDetail->grp_type]),
			),
		)); ?>
	</div>
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
				...
				'stk_cd',
				'grp_emi',
				array('name'=>'grp_type','value'=>AConstant::$grp_type_emitent[$modelDetailUpd->grp_type]),
			),
		)); ?>
	</div>
 </div>
