...
<h1>View Chart of Accounts Inbox #<?php echo $model->update_seq; ?></h1>

<?php AHelper::showFlash($this) ?> <!-- show flash -->

<h4>Data Chart of Accounts</h4>
<div class="row-fluid">
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
				...
				'sl_a',
				'acct_name',
				array('name'=>'acct_stat','value'=>$modelDetail->acct_stat=='A'?'ACTIVE':'CLOSED'),
				'brch_cd',
				'prt_type',
				'acct_type',
				'acct_short',
	...
	<div class="span6">
		<?php $this->widget('bootstrap.widgets.TbDetailView',array(
			...
			'attributes'=>array(
				...
				'sl_a',
				'acct_name',
				array('name'=>'acct_stat','value'=>$modelDetailUpd->acct_stat=='A'?'ACTIVE':'CLOSED'),
				'brch_cd',
				'prt_type',
				'acct_type',
				'acct_short',
