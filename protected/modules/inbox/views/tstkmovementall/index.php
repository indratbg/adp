...
$this->breadcrumbs=array(
	...
	'Unprocessed Stock Movement Inbox',
);

$this->menu=array(
	array('label'=>'Unprocessed Stock Movement Inbox', 'itemOptions'=>array('style'=>'font-size:30px;font-weight:bold;color:black;margin-left:-17px')),
		...
		'actionButtons' => array(
			...
			array(
				...
				'click' => 'js:function(checked_element){
						...
						showPopupModal("Reject Reason","'.(Yii::app()->getBaseUrl(true).'/index.php?r=inbox/tstkmovementall/AjxPopRejectChecked').'"+temp);	
				}'
			)
		),
		...
		array(
			...
			'buttons'=>array(
		        'approve'=>array(
		        	'label'=>'approve', 
		            'icon' =>'ok',
		            'url'  =>'Yii::app()->createUrl("/inbox/tstkmovementall/approve", array("id" => $data->primaryKey))',				// AH : change 
		        	'click' => 'js:function(e){
		        		e.preventDefault();	
						$.ajax({
							type    :"POST",
		         ...
		         'reject'=>array(
		         	'label'=>'reject',
		            'icon'=> 'remove',
		            'url' => 'Yii::app()->createUrl("/inbox/tstkmovementall/AjxPopReject", array("id" => $data->primaryKey))',			// AH : change
		            'click'=>'js:function(e){
		            	e.preventDefault();
