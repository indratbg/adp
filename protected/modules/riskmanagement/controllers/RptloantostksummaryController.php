...
class RptloantostksummaryController extends AAdminController
{

    public $layout = '//layouts/admin_column3';
    public function actionIndex()
    {
        $model = new Rptloantostksummary('LOAN_TO_ASSET_STOCK_SUMMARY', 'R_LOAN_ASSET_STOCK_SUMMARY', 'Loan_to_asset_stock_summary.rptdesign');
        ...
        $model->price_date = Rptloantostksummary::getPriceDate($model->trx_date);
        $model->acct_type = 'M';
        ...
        $model->disc_perc=0;
        $url = '';
        if (isset($_POST['Rptloantostksummary']))
        {
            $model->attributes = $_POST['Rptloantostksummary'];
