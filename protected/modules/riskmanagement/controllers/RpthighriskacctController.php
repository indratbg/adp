...
class RpthighriskacctController extends AAdminController
{

    public $layout = '//layouts/admin_column3';
    public function actionIndex()
    {
        $model = new Rpthighriskacct('HIGH_RISK_ACCT', 'R_HIGH_RISK_ACCT', 'High_Risk_Account.rptdesign');
        ...
        $model->rem_option = '0';
        $model->high_risk_type='MC';
        $model->buy_back = '500000000';
        $model->port_disc='65';
        $model->port_ori = '65';
        $url = '';
        if (isset($_POST['Rpthighriskacct']))
        {
            $model->attributes = $_POST['Rpthighriskacct'];
