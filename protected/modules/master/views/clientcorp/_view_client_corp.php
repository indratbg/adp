...
<div class="row-fluid">
	<div class="span4">
		<?php echo $form->textFieldRow($modelClientInstDetail,'suppl_doc_type', array('class'=>'span7','readonly'=>'readonly','value'=>Parameter::getParamDesc('SUPPL', $modelClientInstDetail->suppl_doc_type))); ?>	
	</div>
	<div class="span3">
		<div class="span7">
			<?php echo $form->label($modelClientInstDetail,'suppl_exp_date',array('class'=>'control-label')); ?>
		</div>
		<?php echo $form->textField($modelClientInstDetail,'suppl_exp_date', array('class'=>'span5','readonly'=>'readonly','value'=>Tmanydetail::reformatDate($modelClientInstDetail->suppl_exp_date))); ?>
	</div>
</div>
