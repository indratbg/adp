...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->errorSummary(array($model,$modelCif,$modelClientinst)); ?>
	
	<?php foreach($modelClientAutho as $row)echo $form->errorSummary($row) ?>
				...
				<div class="control-group">
					...
					<div class = "controls">
		        		...
		        		<?php $this->widget('application.extensions.widget.JuiAutoCompleteStd', array(
												...
												'htmlOptions'=>array('id'=>'auto_comp_cif','name'=>'auto_comp_cif','class'=>'span6'),
										)); ?>
	...
	<?php endif; ?>
	<?php if($render):?>
	<?php echo $this->renderPartial('_form_after_validate', array('model'=>$model,'supplRequired'=>$supplRequired,'modelClientinst'=>$modelClientinst,
												...
												'cancel_reason'=>$cancel_reason,'cancel_reason_autho'=>$cancel_reason_autho)); ?>
...
<script>
	...
	var authoCount = <?php echo count($modelClientAutho)*3 ?>;
	...
	$('#btnSubmit').click(function()
	{
		...
		{
			showPopupModal("Modify Reason","<?php echo Yii::app()->createUrl("/master/clientcorp/ajxPopModify",array('modifyReason'=>$cancel_reason)) ?>");
