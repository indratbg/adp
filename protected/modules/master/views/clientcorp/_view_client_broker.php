...
<div class="row-fluid">
	<div class="control-group">
		...
		<div class="controls">
			Buy
			&emsp;
			<?php echo $form->textField($modelClientDetail,'commission_per_buy',array('class'=>'span2 tnumber','readonly'=>'readonly','value'=>$modelClientDetail->commission_per_buy/100)); ?>
			&emsp;&emsp;	
			Sell
			&emsp;	
			<?php echo $form->textField($modelClientDetail,'commission_per_sell',array('class'=>'span2 tnumber','readonly'=>'readonly','value'=>$modelClientDetail->commission_per_sell/100)); ?>
		</div>
	</div>
</div>
