...
<?php
	$modelCifDetail->sid = substr($modelCifDetail->sid,0,2).'.'.substr($modelCifDetail->sid,2,1).'.'.substr($modelCifDetail->sid,3,4).'.'.substr($modelCifDetail->sid,7,6).'.'.substr($modelCifDetail->sid,13,2);
	$modelCifDetail->npwp_no = substr($modelCifDetail->npwp_no,0,2).'.'.substr($modelCifDetail->npwp_no,2,3).'.'.substr($modelCifDetail->npwp_no,5,3).'.'.substr($modelCifDetail->npwp_no,8,1).'-'.substr($modelCifDetail->npwp_no,9,3).'.'.substr($modelCifDetail->npwp_no,12,3);
?>
...
<div class="row-fluid">
	...
	<div class="span6">
		<div class="control-group">
			<?php echo $form->label($modelCifDetail,'nick_name',array('class'=>'control-label')) ?>
			<div class="controls">
				<?php echo $form->textField($modelCifDetail,'nick_name',array('class'=>'span4','readonly'=>'readonly')); ?>
			</div>
		</div>		
	</div>
</div>	
