<div class="row-fluid">
	...
	<div class="span6">
		<?php echo $form->textFieldRow($modelClientIndiDetail,'spouse_relationship',array('class'=>'span8','readonly'=>'readonly','value'=>$modelClientIndiDetail->spouse_relationship?AConstant::$spouse_relation[$modelClientIndiDetail->spouse_relationship]:'')); ?>
	</div>
</div>
...
<div class="row-fluid">
	<div class="span6">
		<?php echo $form->textFieldRow($modelClientIndiDetail,'spouse_income_cd',array('class'=>'span8','readonly'=>'readonly','value'=>Parameter::getParamDesc('FUND', $modelClientIndiDetail->spouse_income_cd))); ?>
	</div>
	<div class="span6">
		<?php echo $form->textFieldRow($modelClientIndiDetail,'spouse_addl_amount',array('class'=>'span8','readonly'=>'readonly','value'=>Parameter::getParamDesc('FUND', $modelClientIndiDetail->spouse_addl_amount))); ?>
	</div>
</div>
